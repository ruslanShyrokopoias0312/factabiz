                                ...
                                <div class="comment_form comment-form standard-page">
                                    ...
                                    <form class="" onsubmit="Messages.create('<?php echo $chat_id; ?>', '<?php echo $user_id; ?>', '<?php echo auth::getAccessToken(); ?>'); return false;">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div class="image-upload-progress hidden" style="vertical-align: middle; width: 100px; height: 1rem; overflow: hidden; font-size: 0.703125rem; background-color: #e9ecef;">
