        ...
        <div id="profile-column-content" class="row content-block col-sm-12 col-md-12 col-lg-12 order-md-1 order-lg-1">
            ...
            <div class="column-content-sidebar col-md-4">
                ...
                <div class="card hidden" id="preview-posts-block">
                    <div class="card-header border-0">
                        <h3 class="card-title">
                            ...
                            <span class="counter-button-title"><?php echo $LANG['page-posts']; ?> <span id="stat_posts_count" class="counter-button-indicator"><?php if ($profileInfo['postsCount'] > 0) echo $profileInfo['postsCount']; ?></span></span>
                        </h3>
                    </div>
                </div>
                ...
                <div class="card" id="preview-people-block">
                    <div class="card-header border-0">
                        <h3 class="card-title"><i class="icofont icofont-users-alt-4 mr-2"></i><span class="counter-button-title"><?php echo $LANG['page-friends']; ?> <span id="stat_friends_count" class="counter-button-indicator"><?php if ($profileInfo['friendsCount'] > 0) echo $profileInfo['friendsCount']; ?></span></span></h3>
                ...
                <div class="card " id="preview-gallery-block">
                    <div class="card-header border-0">
                        <h3 class="card-title"><i class="icofont icofont-image mr-2"></i><span class="counter-button-title"><?php echo $LANG['label-photos']; ?> <span id="stat_photos_count" class="counter-button-indicator"><?php if ($profileInfo['galleryItemsCount'] > 0) echo $profileInfo['galleryItemsCount']; ?></span></span></h3>
                        <span class="action-link">
                            <?php
